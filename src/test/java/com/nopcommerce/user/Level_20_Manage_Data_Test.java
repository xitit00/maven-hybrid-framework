...
public class Level_20_Manage_Data_Test extends BaseTest {
	...
	public void beforeClass(String browserName, String url) {
		...
		// use data test from UserData in com.nopcommerce.data ( no subclass )
//		email = UserData.EMAIL_ADDRESS + generateFakeNumber() + "@fakemail.com";
...
//		year = UserData.YEAR;
		...
		//  use data test from UserData in com.nopcommerce.data (subclass)
		email = UserData.Register.EMAIL_ADDRESS + generateFakeNumber() + "@fakemail.com";
