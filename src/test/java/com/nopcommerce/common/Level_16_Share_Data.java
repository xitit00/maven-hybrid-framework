...
public class Level_16_Share_Data extends BaseTest {
	...
	public void beforeClass(String browserName, String url) {
		...
		// email , password ở đâu ra để input , làm sao để lấy data từ Common_01_Register_Account 
		// => Ở Common_01_Register_Account , lúc khai báo tham số thêm biến static ở email , password để có thể gọi ở class khác
		
		email = Common_01_Register_Account.email;
